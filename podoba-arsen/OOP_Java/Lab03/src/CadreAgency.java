...
public class CadreAgency implements Serializable
{
    ...
    CadreAgency()
    {
        ...
        people.add(new Person(
                        ...
                        "Economical science",
                new RequireToFutureWork("Director of financial part", null, 0),
    ...
    public void addPerson()
    {
        ...
        else if (choice.equals("y"))
        {
            ...
            people.add(new Person(job, education, new RequireToFutureWork(specialtyWanted, conditionOfwork, minSalary), LocalDate.of(year, month, day)));
